...
<div class="header bg-primary pb-6">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              ...
              <a href="" class="btn btn-sm btn-neutral">Packages  list</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <form action="{{route('addcategory')}}" method="POST" class="form" enctype="multipart/form-data">
      @csrf
    ...
    <div class="form-group">
      <br>
        ...
        <input class="form-control" type="text" value=""name="category_name" required>
    </div>
