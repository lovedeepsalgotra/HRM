...
<div class="header bg-primary pb-6">
    ...
    <form action="{{route('updatetestimonial')}}" method="post" class="form" enctype="multipart/form-data">
      @csrf
    ...
    <br>
        ...
        <input class="form-control" type="text" value="{{$gettestimonialdata->tesdescription}}"name="tesdescription">
    </div>
    <div class="form-group">
        <label for="example-text-input" class="form-control-label">Testimonial Author-Name</label>
        <input class="form-control" type="text" value="{{$gettestimonialdata->authorname}}"name="authorname">
</div>
<input type="hidden" name="id" value="{{$gettestimonialdata->id}}">
