...
<div class="header bg-primary pb-6">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              ...
              <a href="" class="btn btn-sm btn-neutral">Doctor list</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" value="" name="mobileno" required>
    </div>
    <div class="form-group">
    <label class="example-email-input">Email</label>
    <input class="form-control" value="" name="email" required>
    </div>
   
    <div class="form-group">
    <label class="example-message-input">Message</label>
    <input class="form-control" value="" name="message" required>
    </div>
